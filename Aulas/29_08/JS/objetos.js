...
//Em javascript um objeto é declarado com chaves {} sua caracteristica é possui chaves e valor 
//Assim como variaveis as chaves devem seguir um padraaão de nomeclartura
let objeto = {
    nome: 'Gusavo Dias',
    idade: 19,
    cidade: 'Cariacica',
    'data de hoje' : '29/08' , // não se deve declarar uma chave assim  memsmo que seja possivel
};
...
//Json Java Script Objetct Nocation
